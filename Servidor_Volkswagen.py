            ...
            <div class="flex-row">
                ...
                <div class="flex-col">
                    ...
                    <select id="parte" required>
                        <option value="" disabled selected>Selecciona la parte de carrocería</option>
                        <option value="Ensamble Tapa Trasera Interior">Ensamble Tapa Trasera Interior</option>
                        <option value="Puerta Delantera Izquierda">Puerta Delantera Izquierda</option>
                        <option value="Puerta Delantera Derecha">Puerta Delantera Derecha</option>
                        <option value="Puerta Trasera Izquierda">Puerta Trasera Izquierda</option>
                        <option value="Puerta Trasera Derecha">Puerta Trasera Derecha</option>
                        <option value="Cofre">Cofre</option>
                        <option value="Toldo / Techo">Toldo / Techo</option>
                        <option value="Panel Lateral Exterior">Panel Lateral Exterior</option>
                        <option value="Salpicadera">Salpicadera</option>
                        <option value="Piso / Chasis">Piso / Chasis</option>
