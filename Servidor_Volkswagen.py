...
class ClinchadoHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def enviar_email(self, data, dictamen, bg_color):
        ...
        # === CONSTRUCCIÓN DEL PDF (Con el logo de VW de Mexico) ===
        # Se agrega la etiqueta <img> centrada si la imagen se cargó correctamente.
        pdf_logo_html = f'<div style="text-align: center; margin-bottom: 20px;"><img src="{img_pdf_base64}" style="width: 250px; height: auto;" /></div>' if img_pdf_base64 else ''
        ...
        # === CONSTRUCCIÓN DEL CORREO HTML (Con el logo circular de VW) ===
