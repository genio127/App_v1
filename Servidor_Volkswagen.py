...
<div class="container">
    ...
    <form id="clinchadoForm">
        <!-- SECCIÓN 1 (Regresa el ingreso de contraseña de App) -->
        <div class="section">
...
class ClinchadoHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def enviar_email(self, data, dictamen, bg_color):
        ...
        # Detector automático de dominio SMTP mejorado
        ...
        msg = MIMEMultipart()
        msg['From'] = data['userEmail']
        msg['To'] = data['supervisor']
        msg['Subject'] = f"Reporte de Clinchados: {data['parte']} - {data['auto']} (Enviado por: {data['inspector']})"
