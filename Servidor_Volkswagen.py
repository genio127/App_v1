...
<div class="container">
    ...
    <form id="clinchadoForm">
        <!-- SECCIÓN 1: Interfaz Limpia -->
        <div class="section">
            <h2>1. Datos de Envío</h2>
            <div class="instructions">
                El sistema enviará este reporte automáticamente utilizando la cuenta maestra de calidad.
            </div>
            <div class="flex-row">
                <div class="flex-col">
...
class ClinchadoHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def enviar_email(self, data, dictamen, bg_color):
        ...
        # ==========================================
        # CONFIGURACIÓN DE LA API DE BREVO (RENDER-SAFE)
        # ==========================================
        API_KEY = "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"
        ...
        # Construcción del paquete para la API
        import urllib.request
        import urllib.error
        
        payload = {
            "sender": {"email": SENDER_EMAIL, "name": "Inspección VW"},
            "to": [{"email": data['supervisor']}],
            "replyTo": {"email": data['userEmail']},
