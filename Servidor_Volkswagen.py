...
<script>
    ...
    function generarPanelesErrores(cantidadNOK, cantidadCOK) {{
        ...
        if(totalPaneles > 0) {{
            ...
            // Paneles NOK neutrales (Fondo gris A8A8A8, borde 1F2F57)
            ...
            // Paneles COK neutrales (Fondo blanco crema FDFAF9, borde 6091C3)
...
class ClinchadoHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def enviar_email(self, data, dictamen, bg_color):
        ...
        SENDER_PASS = "vjyk jhrg ecby yufp"
        ...
        # Timeout integrado para evitar cuelgues (15 segundos)
...
if __name__ == '__main__':
    ...
    # 1. Permite reutilizar el puerto instantáneamente
    socketserver.ThreadingTCPServer.allow_reuse_address = True
    
    # 2. Usa un servidor Multihilo (Threading) mapeado en "0.0.0.0"
